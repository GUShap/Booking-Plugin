...
if ( ! class_exists( 'Gs_Booking' ) ) :
	...
	final class Gs_Booking {
		...
		private function includes() {
			...
			require_once GSBOOKING_PLUGIN_DIR . 'core/includes/hooks/email-actions.php';
            ...
            require_once GSBOOKING_PLUGIN_DIR . 'core/includes/templates/gs-bookings-email-templates.php';
